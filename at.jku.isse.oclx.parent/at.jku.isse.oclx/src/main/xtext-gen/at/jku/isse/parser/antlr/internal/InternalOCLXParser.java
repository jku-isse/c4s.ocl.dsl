...
public class InternalOCLXParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_DESCRIPTION", "RULE_INT", "RULE_STRING", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'rule'", "'{'", "'description:'", "'is'", "'overrulable:'", "'context:'", "'expression:'", "'}'", "'.'", "'>'", "'<'", "'>='", "'<='", "'='", "'<>'", "'and'", "'or'", "'xor'", "'implies'", "'*'", "'/'", "'+'", "'-'", "'->'", "'not'", "'('", "')'", "'self'", "'true'", "'false'", "'null'", "'|'", "'FORALL'", "'EXISTS'", "'COLLECT'", "'REJECT'", "'SELECT'", "':'", "'()'", "'SET'", "'LIST'", "'MAP'", "'COLLECTION'", "','"
    };
    ...
    // InternalOCLX.g:469:1: rulePrefixedExp returns [EObject current=null] : ( ( () ( (lv_operators_1_0= ruleUnaryOperator ) )+ ( (lv_expression_2_0= rulePrimaryExp ) ) ) | this_PrimaryExp_3= rulePrimaryExp ) ;
    public final EObject rulePrefixedExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:475:2: ( ( ( () ( (lv_operators_1_0= ruleUnaryOperator ) )+ ( (lv_expression_2_0= rulePrimaryExp ) ) ) | this_PrimaryExp_3= rulePrimaryExp ) )
            // InternalOCLX.g:476:2: ( ( () ( (lv_operators_1_0= ruleUnaryOperator ) )+ ( (lv_expression_2_0= rulePrimaryExp ) ) ) | this_PrimaryExp_3= rulePrimaryExp )
            {
            // InternalOCLX.g:476:2: ( ( () ( (lv_operators_1_0= ruleUnaryOperator ) )+ ( (lv_expression_2_0= rulePrimaryExp ) ) ) | this_PrimaryExp_3= rulePrimaryExp )
            int alt8=2;
            ...
            else if ( (LA8_0==RULE_ID||(LA8_0>=RULE_INT && LA8_0<=RULE_STRING)||LA8_0==37||(LA8_0>=39 && LA8_0<=42)) ) {
                alt8=2;
            }
            else {
            ...
            switch (alt8) {
                case 1 :
                    // InternalOCLX.g:477:3: ( () ( (lv_operators_1_0= ruleUnaryOperator ) )+ ( (lv_expression_2_0= rulePrimaryExp ) ) )
                    {
                    // InternalOCLX.g:477:3: ( () ( (lv_operators_1_0= ruleUnaryOperator ) )+ ( (lv_expression_2_0= rulePrimaryExp ) ) )
                    // InternalOCLX.g:478:4: () ( (lv_operators_1_0= ruleUnaryOperator ) )+ ( (lv_expression_2_0= rulePrimaryExp ) )
                    {
                    ...
                    // InternalOCLX.g:485:4: ( (lv_operators_1_0= ruleUnaryOperator ) )+
                    int cnt7=0;
                    loop7:
                    do {
                        int alt7=2;
                        ...
                        switch (alt7) {
                    	case 1 :
                    	    // InternalOCLX.g:486:5: (lv_operators_1_0= ruleUnaryOperator )
                    	    {
                    	    // InternalOCLX.g:486:5: (lv_operators_1_0= ruleUnaryOperator )
                    	    // InternalOCLX.g:487:6: lv_operators_1_0= ruleUnaryOperator
                    	    {
    ...
    // InternalOCLX.g:891:1: rulePrimaryExp returns [EObject current=null] : (this_NestedExp_0= ruleNestedExp | (this_VarOrSelfExp_1= ruleVarOrSelfExp ( ( (lv_nav_2_0= ruleNavigationOperator ) ) ( (lv_methods_3_0= ruleMethodExp ) ) )* ) | this_PrimitiveLiteralExp_4= rulePrimitiveLiteralExp ) ;
    public final EObject rulePrimaryExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:897:2: ( (this_NestedExp_0= ruleNestedExp | (this_VarOrSelfExp_1= ruleVarOrSelfExp ( ( (lv_nav_2_0= ruleNavigationOperator ) ) ( (lv_methods_3_0= ruleMethodExp ) ) )* ) | this_PrimitiveLiteralExp_4= rulePrimitiveLiteralExp ) )
            // InternalOCLX.g:898:2: (this_NestedExp_0= ruleNestedExp | (this_VarOrSelfExp_1= ruleVarOrSelfExp ( ( (lv_nav_2_0= ruleNavigationOperator ) ) ( (lv_methods_3_0= ruleMethodExp ) ) )* ) | this_PrimitiveLiteralExp_4= rulePrimitiveLiteralExp )
            {
            // InternalOCLX.g:898:2: (this_NestedExp_0= ruleNestedExp | (this_VarOrSelfExp_1= ruleVarOrSelfExp ( ( (lv_nav_2_0= ruleNavigationOperator ) ) ( (lv_methods_3_0= ruleMethodExp ) ) )* ) | this_PrimitiveLiteralExp_4= rulePrimitiveLiteralExp )
            int alt15=3;
            switch ( input.LA(1) ) {
    ...
    // InternalOCLX.g:971:1: entryRuleNestedExp returns [EObject current=null] : iv_ruleNestedExp= ruleNestedExp EOF ;
    public final EObject entryRuleNestedExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:971:50: (iv_ruleNestedExp= ruleNestedExp EOF )
            // InternalOCLX.g:972:2: iv_ruleNestedExp= ruleNestedExp EOF
            {
    ...
    // InternalOCLX.g:978:1: ruleNestedExp returns [EObject current=null] : (otherlv_0= '(' ( (lv_source_1_0= ruleExp ) ) otherlv_2= ')' ) ;
    public final EObject ruleNestedExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:984:2: ( (otherlv_0= '(' ( (lv_source_1_0= ruleExp ) ) otherlv_2= ')' ) )
            // InternalOCLX.g:985:2: (otherlv_0= '(' ( (lv_source_1_0= ruleExp ) ) otherlv_2= ')' )
            {
            // InternalOCLX.g:985:2: (otherlv_0= '(' ( (lv_source_1_0= ruleExp ) ) otherlv_2= ')' )
            // InternalOCLX.g:986:3: otherlv_0= '(' ( (lv_source_1_0= ruleExp ) ) otherlv_2= ')'
            {
            ...
            // InternalOCLX.g:990:3: ( (lv_source_1_0= ruleExp ) )
            // InternalOCLX.g:991:4: (lv_source_1_0= ruleExp )
            {
            // InternalOCLX.g:991:4: (lv_source_1_0= ruleExp )
            // InternalOCLX.g:992:5: lv_source_1_0= ruleExp
            {
    ...
    // InternalOCLX.g:1017:1: entryRuleVarOrSelfExp returns [EObject current=null] : iv_ruleVarOrSelfExp= ruleVarOrSelfExp EOF ;
    public final EObject entryRuleVarOrSelfExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1017:53: (iv_ruleVarOrSelfExp= ruleVarOrSelfExp EOF )
            // InternalOCLX.g:1018:2: iv_ruleVarOrSelfExp= ruleVarOrSelfExp EOF
            {
    ...
    // InternalOCLX.g:1024:1: ruleVarOrSelfExp returns [EObject current=null] : (this_SelfExp_0= ruleSelfExp | this_VarReference_1= ruleVarReference ) ;
    public final EObject ruleVarOrSelfExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1030:2: ( (this_SelfExp_0= ruleSelfExp | this_VarReference_1= ruleVarReference ) )
            // InternalOCLX.g:1031:2: (this_SelfExp_0= ruleSelfExp | this_VarReference_1= ruleVarReference )
            {
            // InternalOCLX.g:1031:2: (this_SelfExp_0= ruleSelfExp | this_VarReference_1= ruleVarReference )
            int alt16=2;
            ...
            switch (alt16) {
                case 1 :
                    // InternalOCLX.g:1032:3: this_SelfExp_0= ruleSelfExp
                    {
                    ...
                    break;
                case 2 :
                    // InternalOCLX.g:1041:3: this_VarReference_1= ruleVarReference
                    {
    ...
    // InternalOCLX.g:1053:1: entryRuleSelfExp returns [EObject current=null] : iv_ruleSelfExp= ruleSelfExp EOF ;
    public final EObject entryRuleSelfExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1053:48: (iv_ruleSelfExp= ruleSelfExp EOF )
            // InternalOCLX.g:1054:2: iv_ruleSelfExp= ruleSelfExp EOF
            {
    ...
    // InternalOCLX.g:1060:1: ruleSelfExp returns [EObject current=null] : ( () ( (lv_name_1_0= 'self' ) ) ) ;
    public final EObject ruleSelfExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1066:2: ( ( () ( (lv_name_1_0= 'self' ) ) ) )
            // InternalOCLX.g:1067:2: ( () ( (lv_name_1_0= 'self' ) ) )
            {
            // InternalOCLX.g:1067:2: ( () ( (lv_name_1_0= 'self' ) ) )
            // InternalOCLX.g:1068:3: () ( (lv_name_1_0= 'self' ) )
            {
            // InternalOCLX.g:1068:3: ()
            // InternalOCLX.g:1069:4: 
            {
            ...
            // InternalOCLX.g:1075:3: ( (lv_name_1_0= 'self' ) )
            // InternalOCLX.g:1076:4: (lv_name_1_0= 'self' )
            {
            // InternalOCLX.g:1076:4: (lv_name_1_0= 'self' )
            // InternalOCLX.g:1077:5: lv_name_1_0= 'self'
            {
    ...
    // InternalOCLX.g:1093:1: entryRuleVarDeclaration returns [EObject current=null] : iv_ruleVarDeclaration= ruleVarDeclaration EOF ;
    public final EObject entryRuleVarDeclaration() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1093:55: (iv_ruleVarDeclaration= ruleVarDeclaration EOF )
            // InternalOCLX.g:1094:2: iv_ruleVarDeclaration= ruleVarDeclaration EOF
            {
    ...
    // InternalOCLX.g:1100:1: ruleVarDeclaration returns [EObject current=null] : ( (lv_name_0_0= ruleSimpleName ) ) ;
    public final EObject ruleVarDeclaration() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1106:2: ( ( (lv_name_0_0= ruleSimpleName ) ) )
            // InternalOCLX.g:1107:2: ( (lv_name_0_0= ruleSimpleName ) )
            {
            // InternalOCLX.g:1107:2: ( (lv_name_0_0= ruleSimpleName ) )
            // InternalOCLX.g:1108:3: (lv_name_0_0= ruleSimpleName )
            {
            // InternalOCLX.g:1108:3: (lv_name_0_0= ruleSimpleName )
            // InternalOCLX.g:1109:4: lv_name_0_0= ruleSimpleName
            {
    ...
    // InternalOCLX.g:1129:1: entryRuleVarReference returns [EObject current=null] : iv_ruleVarReference= ruleVarReference EOF ;
    public final EObject entryRuleVarReference() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1129:53: (iv_ruleVarReference= ruleVarReference EOF )
            // InternalOCLX.g:1130:2: iv_ruleVarReference= ruleVarReference EOF
            {
    ...
    // InternalOCLX.g:1136:1: ruleVarReference returns [EObject current=null] : ( (otherlv_0= RULE_ID ) ) ;
    public final EObject ruleVarReference() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1142:2: ( ( (otherlv_0= RULE_ID ) ) )
            // InternalOCLX.g:1143:2: ( (otherlv_0= RULE_ID ) )
            {
            // InternalOCLX.g:1143:2: ( (otherlv_0= RULE_ID ) )
            // InternalOCLX.g:1144:3: (otherlv_0= RULE_ID )
            {
            // InternalOCLX.g:1144:3: (otherlv_0= RULE_ID )
            // InternalOCLX.g:1145:4: otherlv_0= RULE_ID
            {
    ...
    // InternalOCLX.g:1159:1: entryRulePrimitiveLiteralExp returns [EObject current=null] : iv_rulePrimitiveLiteralExp= rulePrimitiveLiteralExp EOF ;
    public final EObject entryRulePrimitiveLiteralExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1159:60: (iv_rulePrimitiveLiteralExp= rulePrimitiveLiteralExp EOF )
            // InternalOCLX.g:1160:2: iv_rulePrimitiveLiteralExp= rulePrimitiveLiteralExp EOF
            {
    ...
    // InternalOCLX.g:1166:1: rulePrimitiveLiteralExp returns [EObject current=null] : (this_NumberLiteralExp_0= ruleNumberLiteralExp | this_StringLiteralExp_1= ruleStringLiteralExp | this_BooleanLiteralExp_2= ruleBooleanLiteralExp | this_NullLiteralExp_3= ruleNullLiteralExp ) ;
    public final EObject rulePrimitiveLiteralExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1172:2: ( (this_NumberLiteralExp_0= ruleNumberLiteralExp | this_StringLiteralExp_1= ruleStringLiteralExp | this_BooleanLiteralExp_2= ruleBooleanLiteralExp | this_NullLiteralExp_3= ruleNullLiteralExp ) )
            // InternalOCLX.g:1173:2: (this_NumberLiteralExp_0= ruleNumberLiteralExp | this_StringLiteralExp_1= ruleStringLiteralExp | this_BooleanLiteralExp_2= ruleBooleanLiteralExp | this_NullLiteralExp_3= ruleNullLiteralExp )
            {
            // InternalOCLX.g:1173:2: (this_NumberLiteralExp_0= ruleNumberLiteralExp | this_StringLiteralExp_1= ruleStringLiteralExp | this_BooleanLiteralExp_2= ruleBooleanLiteralExp | this_NullLiteralExp_3= ruleNullLiteralExp )
            int alt17=4;
            switch ( input.LA(1) ) {
            ...
            switch (alt17) {
                case 1 :
                    // InternalOCLX.g:1174:3: this_NumberLiteralExp_0= ruleNumberLiteralExp
                    {
                    ...
                    break;
                case 2 :
                    // InternalOCLX.g:1183:3: this_StringLiteralExp_1= ruleStringLiteralExp
                    {
                    ...
                    break;
                case 3 :
                    // InternalOCLX.g:1192:3: this_BooleanLiteralExp_2= ruleBooleanLiteralExp
                    {
                    ...
                    break;
                case 4 :
                    // InternalOCLX.g:1201:3: this_NullLiteralExp_3= ruleNullLiteralExp
                    {
    ...
    // InternalOCLX.g:1213:1: entryRuleNumberLiteralExp returns [EObject current=null] : iv_ruleNumberLiteralExp= ruleNumberLiteralExp EOF ;
    public final EObject entryRuleNumberLiteralExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1213:57: (iv_ruleNumberLiteralExp= ruleNumberLiteralExp EOF )
            // InternalOCLX.g:1214:2: iv_ruleNumberLiteralExp= ruleNumberLiteralExp EOF
            {
    ...
    // InternalOCLX.g:1220:1: ruleNumberLiteralExp returns [EObject current=null] : ( (lv_value_0_0= RULE_INT ) ) ;
    public final EObject ruleNumberLiteralExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1226:2: ( ( (lv_value_0_0= RULE_INT ) ) )
            // InternalOCLX.g:1227:2: ( (lv_value_0_0= RULE_INT ) )
            {
            // InternalOCLX.g:1227:2: ( (lv_value_0_0= RULE_INT ) )
            // InternalOCLX.g:1228:3: (lv_value_0_0= RULE_INT )
            {
            // InternalOCLX.g:1228:3: (lv_value_0_0= RULE_INT )
            // InternalOCLX.g:1229:4: lv_value_0_0= RULE_INT
            {
    ...
    // InternalOCLX.g:1248:1: entryRuleStringLiteralExp returns [EObject current=null] : iv_ruleStringLiteralExp= ruleStringLiteralExp EOF ;
    public final EObject entryRuleStringLiteralExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1248:57: (iv_ruleStringLiteralExp= ruleStringLiteralExp EOF )
            // InternalOCLX.g:1249:2: iv_ruleStringLiteralExp= ruleStringLiteralExp EOF
            {
    ...
    // InternalOCLX.g:1255:1: ruleStringLiteralExp returns [EObject current=null] : ( (lv_value_0_0= RULE_STRING ) ) ;
    public final EObject ruleStringLiteralExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1261:2: ( ( (lv_value_0_0= RULE_STRING ) ) )
            // InternalOCLX.g:1262:2: ( (lv_value_0_0= RULE_STRING ) )
            {
            // InternalOCLX.g:1262:2: ( (lv_value_0_0= RULE_STRING ) )
            // InternalOCLX.g:1263:3: (lv_value_0_0= RULE_STRING )
            {
            // InternalOCLX.g:1263:3: (lv_value_0_0= RULE_STRING )
            // InternalOCLX.g:1264:4: lv_value_0_0= RULE_STRING
            {
    ...
    // InternalOCLX.g:1283:1: entryRuleBooleanLiteralExp returns [EObject current=null] : iv_ruleBooleanLiteralExp= ruleBooleanLiteralExp EOF ;
    public final EObject entryRuleBooleanLiteralExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1283:58: (iv_ruleBooleanLiteralExp= ruleBooleanLiteralExp EOF )
            // InternalOCLX.g:1284:2: iv_ruleBooleanLiteralExp= ruleBooleanLiteralExp EOF
            {
    ...
    // InternalOCLX.g:1290:1: ruleBooleanLiteralExp returns [EObject current=null] : ( ( (lv_value_0_0= 'true' ) ) | ( (lv_value_1_0= 'false' ) ) ) ;
    public final EObject ruleBooleanLiteralExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1296:2: ( ( ( (lv_value_0_0= 'true' ) ) | ( (lv_value_1_0= 'false' ) ) ) )
            // InternalOCLX.g:1297:2: ( ( (lv_value_0_0= 'true' ) ) | ( (lv_value_1_0= 'false' ) ) )
            {
            // InternalOCLX.g:1297:2: ( ( (lv_value_0_0= 'true' ) ) | ( (lv_value_1_0= 'false' ) ) )
            int alt18=2;
            ...
            switch (alt18) {
                case 1 :
                    // InternalOCLX.g:1298:3: ( (lv_value_0_0= 'true' ) )
                    {
                    // InternalOCLX.g:1298:3: ( (lv_value_0_0= 'true' ) )
                    // InternalOCLX.g:1299:4: (lv_value_0_0= 'true' )
                    {
                    // InternalOCLX.g:1299:4: (lv_value_0_0= 'true' )
                    // InternalOCLX.g:1300:5: lv_value_0_0= 'true'
                    {
                    ...
                    break;
                case 2 :
                    // InternalOCLX.g:1313:3: ( (lv_value_1_0= 'false' ) )
                    {
                    // InternalOCLX.g:1313:3: ( (lv_value_1_0= 'false' ) )
                    // InternalOCLX.g:1314:4: (lv_value_1_0= 'false' )
                    {
                    // InternalOCLX.g:1314:4: (lv_value_1_0= 'false' )
                    // InternalOCLX.g:1315:5: lv_value_1_0= 'false'
                    {
    ...
    // InternalOCLX.g:1331:1: entryRuleNullLiteralExp returns [EObject current=null] : iv_ruleNullLiteralExp= ruleNullLiteralExp EOF ;
    public final EObject entryRuleNullLiteralExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1331:55: (iv_ruleNullLiteralExp= ruleNullLiteralExp EOF )
            // InternalOCLX.g:1332:2: iv_ruleNullLiteralExp= ruleNullLiteralExp EOF
            {
    ...
    // InternalOCLX.g:1338:1: ruleNullLiteralExp returns [EObject current=null] : ( () otherlv_1= 'null' ) ;
    public final EObject ruleNullLiteralExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1344:2: ( ( () otherlv_1= 'null' ) )
            // InternalOCLX.g:1345:2: ( () otherlv_1= 'null' )
            {
            // InternalOCLX.g:1345:2: ( () otherlv_1= 'null' )
            // InternalOCLX.g:1346:3: () otherlv_1= 'null'
            {
            // InternalOCLX.g:1346:3: ()
            // InternalOCLX.g:1347:4: 
            {
    ...
    // InternalOCLX.g:1361:1: entryRuleMethodExp returns [EObject current=null] : iv_ruleMethodExp= ruleMethodExp EOF ;
    public final EObject entryRuleMethodExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1361:50: (iv_ruleMethodExp= ruleMethodExp EOF )
            // InternalOCLX.g:1362:2: iv_ruleMethodExp= ruleMethodExp EOF
            {
    ...
    // InternalOCLX.g:1368:1: ruleMethodExp returns [EObject current=null] : (this_PropertyAccess_0= rulePropertyAccess | this_MethodCall_1= ruleMethodCall | this_CollectionIterator_2= ruleCollectionIterator ) ;
    public final EObject ruleMethodExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1374:2: ( (this_PropertyAccess_0= rulePropertyAccess | this_MethodCall_1= ruleMethodCall | this_CollectionIterator_2= ruleCollectionIterator ) )
            // InternalOCLX.g:1375:2: (this_PropertyAccess_0= rulePropertyAccess | this_MethodCall_1= ruleMethodCall | this_CollectionIterator_2= ruleCollectionIterator )
            {
            // InternalOCLX.g:1375:2: (this_PropertyAccess_0= rulePropertyAccess | this_MethodCall_1= ruleMethodCall | this_CollectionIterator_2= ruleCollectionIterator )
            int alt19=3;
            ...
            if ( (LA19_0==RULE_ID) ) {
                ...
                if ( (LA19_1==37||LA19_1==50) ) {
                    alt19=2;
                }
                else if ( (LA19_1==EOF||(LA19_1>=19 && LA19_1<=35)||LA19_1==38||LA19_1==55) ) {
                    alt19=1;
                }
                else {
                    NoViableAltException nvae =
            ...
            switch (alt19) {
                case 1 :
                    // InternalOCLX.g:1376:3: this_PropertyAccess_0= rulePropertyAccess
                    {
                    ...
                    break;
                case 2 :
                    // InternalOCLX.g:1385:3: this_MethodCall_1= ruleMethodCall
                    {
                    ...
                    break;
                case 3 :
                    // InternalOCLX.g:1394:3: this_CollectionIterator_2= ruleCollectionIterator
                    {
    ...
    // InternalOCLX.g:1406:1: entryRuleCollectionIterator returns [EObject current=null] : iv_ruleCollectionIterator= ruleCollectionIterator EOF ;
    public final EObject entryRuleCollectionIterator() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1406:59: (iv_ruleCollectionIterator= ruleCollectionIterator EOF )
            // InternalOCLX.g:1407:2: iv_ruleCollectionIterator= ruleCollectionIterator EOF
            {
    ...
    // InternalOCLX.g:1413:1: ruleCollectionIterator returns [EObject current=null] : ( ( (lv_name_0_0= ruleIteratorName ) ) otherlv_1= '(' ( (lv_itervar_2_0= ruleIteratorVarDeclaration ) ) otherlv_3= '|' ( (lv_body_4_0= ruleExp ) ) otherlv_5= ')' ) ;
    public final EObject ruleCollectionIterator() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1419:2: ( ( ( (lv_name_0_0= ruleIteratorName ) ) otherlv_1= '(' ( (lv_itervar_2_0= ruleIteratorVarDeclaration ) ) otherlv_3= '|' ( (lv_body_4_0= ruleExp ) ) otherlv_5= ')' ) )
            // InternalOCLX.g:1420:2: ( ( (lv_name_0_0= ruleIteratorName ) ) otherlv_1= '(' ( (lv_itervar_2_0= ruleIteratorVarDeclaration ) ) otherlv_3= '|' ( (lv_body_4_0= ruleExp ) ) otherlv_5= ')' )
            {
            // InternalOCLX.g:1420:2: ( ( (lv_name_0_0= ruleIteratorName ) ) otherlv_1= '(' ( (lv_itervar_2_0= ruleIteratorVarDeclaration ) ) otherlv_3= '|' ( (lv_body_4_0= ruleExp ) ) otherlv_5= ')' )
            // InternalOCLX.g:1421:3: ( (lv_name_0_0= ruleIteratorName ) ) otherlv_1= '(' ( (lv_itervar_2_0= ruleIteratorVarDeclaration ) ) otherlv_3= '|' ( (lv_body_4_0= ruleExp ) ) otherlv_5= ')'
            {
            // InternalOCLX.g:1421:3: ( (lv_name_0_0= ruleIteratorName ) )
            // InternalOCLX.g:1422:4: (lv_name_0_0= ruleIteratorName )
            {
            // InternalOCLX.g:1422:4: (lv_name_0_0= ruleIteratorName )
            // InternalOCLX.g:1423:5: lv_name_0_0= ruleIteratorName
            {
            ...
            // InternalOCLX.g:1444:3: ( (lv_itervar_2_0= ruleIteratorVarDeclaration ) )
            // InternalOCLX.g:1445:4: (lv_itervar_2_0= ruleIteratorVarDeclaration )
            {
            // InternalOCLX.g:1445:4: (lv_itervar_2_0= ruleIteratorVarDeclaration )
            // InternalOCLX.g:1446:5: lv_itervar_2_0= ruleIteratorVarDeclaration
            {
            ...
            // InternalOCLX.g:1467:3: ( (lv_body_4_0= ruleExp ) )
            // InternalOCLX.g:1468:4: (lv_body_4_0= ruleExp )
            {
            // InternalOCLX.g:1468:4: (lv_body_4_0= ruleExp )
            // InternalOCLX.g:1469:5: lv_body_4_0= ruleExp
            {
    ...
    // InternalOCLX.g:1494:1: entryRuleIteratorName returns [EObject current=null] : iv_ruleIteratorName= ruleIteratorName EOF ;
    public final EObject entryRuleIteratorName() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1494:53: (iv_ruleIteratorName= ruleIteratorName EOF )
            // InternalOCLX.g:1495:2: iv_ruleIteratorName= ruleIteratorName EOF
            {
    ...
    // InternalOCLX.g:1501:1: ruleIteratorName returns [EObject current=null] : ( ( (lv_name_0_1= 'FORALL' | lv_name_0_2= 'EXISTS' | lv_name_0_3= 'COLLECT' | lv_name_0_4= 'REJECT' | lv_name_0_5= 'SELECT' ) ) ) ;
    public final EObject ruleIteratorName() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1507:2: ( ( ( (lv_name_0_1= 'FORALL' | lv_name_0_2= 'EXISTS' | lv_name_0_3= 'COLLECT' | lv_name_0_4= 'REJECT' | lv_name_0_5= 'SELECT' ) ) ) )
            // InternalOCLX.g:1508:2: ( ( (lv_name_0_1= 'FORALL' | lv_name_0_2= 'EXISTS' | lv_name_0_3= 'COLLECT' | lv_name_0_4= 'REJECT' | lv_name_0_5= 'SELECT' ) ) )
            {
            // InternalOCLX.g:1508:2: ( ( (lv_name_0_1= 'FORALL' | lv_name_0_2= 'EXISTS' | lv_name_0_3= 'COLLECT' | lv_name_0_4= 'REJECT' | lv_name_0_5= 'SELECT' ) ) )
            // InternalOCLX.g:1509:3: ( (lv_name_0_1= 'FORALL' | lv_name_0_2= 'EXISTS' | lv_name_0_3= 'COLLECT' | lv_name_0_4= 'REJECT' | lv_name_0_5= 'SELECT' ) )
            {
            // InternalOCLX.g:1509:3: ( (lv_name_0_1= 'FORALL' | lv_name_0_2= 'EXISTS' | lv_name_0_3= 'COLLECT' | lv_name_0_4= 'REJECT' | lv_name_0_5= 'SELECT' ) )
            // InternalOCLX.g:1510:4: (lv_name_0_1= 'FORALL' | lv_name_0_2= 'EXISTS' | lv_name_0_3= 'COLLECT' | lv_name_0_4= 'REJECT' | lv_name_0_5= 'SELECT' )
            {
            // InternalOCLX.g:1510:4: (lv_name_0_1= 'FORALL' | lv_name_0_2= 'EXISTS' | lv_name_0_3= 'COLLECT' | lv_name_0_4= 'REJECT' | lv_name_0_5= 'SELECT' )
            int alt20=5;
            switch ( input.LA(1) ) {
            ...
            switch (alt20) {
                case 1 :
                    // InternalOCLX.g:1511:5: lv_name_0_1= 'FORALL'
                    {
                    ...
                    break;
                case 2 :
                    // InternalOCLX.g:1522:5: lv_name_0_2= 'EXISTS'
                    {
                    ...
                    break;
                case 3 :
                    // InternalOCLX.g:1533:5: lv_name_0_3= 'COLLECT'
                    {
                    ...
                    break;
                case 4 :
                    // InternalOCLX.g:1544:5: lv_name_0_4= 'REJECT'
                    {
                    ...
                    break;
                case 5 :
                    // InternalOCLX.g:1555:5: lv_name_0_5= 'SELECT'
                    {
    ...
    // InternalOCLX.g:1571:1: entryRuleIteratorVarDeclaration returns [EObject current=null] : iv_ruleIteratorVarDeclaration= ruleIteratorVarDeclaration EOF ;
    public final EObject entryRuleIteratorVarDeclaration() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1571:63: (iv_ruleIteratorVarDeclaration= ruleIteratorVarDeclaration EOF )
            // InternalOCLX.g:1572:2: iv_ruleIteratorVarDeclaration= ruleIteratorVarDeclaration EOF
            {
    ...
    // InternalOCLX.g:1578:1: ruleIteratorVarDeclaration returns [EObject current=null] : ( ( (lv_name_0_0= ruleVarDeclaration ) ) | ( ( (lv_name_1_0= ruleVarDeclaration ) ) otherlv_2= ':' ( (lv_type_3_0= ruleTypeExp ) ) ) ) ;
    public final EObject ruleIteratorVarDeclaration() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1584:2: ( ( ( (lv_name_0_0= ruleVarDeclaration ) ) | ( ( (lv_name_1_0= ruleVarDeclaration ) ) otherlv_2= ':' ( (lv_type_3_0= ruleTypeExp ) ) ) ) )
            // InternalOCLX.g:1585:2: ( ( (lv_name_0_0= ruleVarDeclaration ) ) | ( ( (lv_name_1_0= ruleVarDeclaration ) ) otherlv_2= ':' ( (lv_type_3_0= ruleTypeExp ) ) ) )
            {
            // InternalOCLX.g:1585:2: ( ( (lv_name_0_0= ruleVarDeclaration ) ) | ( ( (lv_name_1_0= ruleVarDeclaration ) ) otherlv_2= ':' ( (lv_type_3_0= ruleTypeExp ) ) ) )
            int alt21=2;
            ...
            switch (alt21) {
                case 1 :
                    // InternalOCLX.g:1586:3: ( (lv_name_0_0= ruleVarDeclaration ) )
                    {
                    // InternalOCLX.g:1586:3: ( (lv_name_0_0= ruleVarDeclaration ) )
                    // InternalOCLX.g:1587:4: (lv_name_0_0= ruleVarDeclaration )
                    {
                    // InternalOCLX.g:1587:4: (lv_name_0_0= ruleVarDeclaration )
                    // InternalOCLX.g:1588:5: lv_name_0_0= ruleVarDeclaration
                    {
                    ...
                    break;
                case 2 :
                    // InternalOCLX.g:1606:3: ( ( (lv_name_1_0= ruleVarDeclaration ) ) otherlv_2= ':' ( (lv_type_3_0= ruleTypeExp ) ) )
                    {
                    // InternalOCLX.g:1606:3: ( ( (lv_name_1_0= ruleVarDeclaration ) ) otherlv_2= ':' ( (lv_type_3_0= ruleTypeExp ) ) )
                    // InternalOCLX.g:1607:4: ( (lv_name_1_0= ruleVarDeclaration ) ) otherlv_2= ':' ( (lv_type_3_0= ruleTypeExp ) )
                    {
                    // InternalOCLX.g:1607:4: ( (lv_name_1_0= ruleVarDeclaration ) )
                    // InternalOCLX.g:1608:5: (lv_name_1_0= ruleVarDeclaration )
                    {
                    // InternalOCLX.g:1608:5: (lv_name_1_0= ruleVarDeclaration )
                    // InternalOCLX.g:1609:6: lv_name_1_0= ruleVarDeclaration
                    {
                    ...
                    // InternalOCLX.g:1630:4: ( (lv_type_3_0= ruleTypeExp ) )
                    // InternalOCLX.g:1631:5: (lv_type_3_0= ruleTypeExp )
                    {
                    // InternalOCLX.g:1631:5: (lv_type_3_0= ruleTypeExp )
                    // InternalOCLX.g:1632:6: lv_type_3_0= ruleTypeExp
                    {
    ...
    // InternalOCLX.g:1654:1: entryRulePropertyAccess returns [EObject current=null] : iv_rulePropertyAccess= rulePropertyAccess EOF ;
    public final EObject entryRulePropertyAccess() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1654:55: (iv_rulePropertyAccess= rulePropertyAccess EOF )
            // InternalOCLX.g:1655:2: iv_rulePropertyAccess= rulePropertyAccess EOF
            {
    ...
    // InternalOCLX.g:1661:1: rulePropertyAccess returns [EObject current=null] : ( (lv_name_0_0= ruleSimpleName ) ) ;
    public final EObject rulePropertyAccess() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1667:2: ( ( (lv_name_0_0= ruleSimpleName ) ) )
            // InternalOCLX.g:1668:2: ( (lv_name_0_0= ruleSimpleName ) )
            {
            // InternalOCLX.g:1668:2: ( (lv_name_0_0= ruleSimpleName ) )
            // InternalOCLX.g:1669:3: (lv_name_0_0= ruleSimpleName )
            {
            // InternalOCLX.g:1669:3: (lv_name_0_0= ruleSimpleName )
            // InternalOCLX.g:1670:4: lv_name_0_0= ruleSimpleName
            {
    ...
    // InternalOCLX.g:1690:1: entryRuleMethodCall returns [EObject current=null] : iv_ruleMethodCall= ruleMethodCall EOF ;
    public final EObject entryRuleMethodCall() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1690:51: (iv_ruleMethodCall= ruleMethodCall EOF )
            // InternalOCLX.g:1691:2: iv_ruleMethodCall= ruleMethodCall EOF
            {
    ...
    // InternalOCLX.g:1697:1: ruleMethodCall returns [EObject current=null] : ( ( ( (lv_name_0_0= ruleSimpleName ) ) otherlv_1= '()' ) | ( ( (lv_name_2_0= ruleSimpleName ) ) otherlv_3= '(' ( (lv_args_4_0= ruleArgumentsExp ) ) otherlv_5= ')' ) | ( ( (lv_name_6_0= ruleSimpleName ) ) otherlv_7= '(' ( (lv_type_8_0= ruleTypeExp ) ) otherlv_9= ')' ) ) ;
    public final EObject ruleMethodCall() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1703:2: ( ( ( ( (lv_name_0_0= ruleSimpleName ) ) otherlv_1= '()' ) | ( ( (lv_name_2_0= ruleSimpleName ) ) otherlv_3= '(' ( (lv_args_4_0= ruleArgumentsExp ) ) otherlv_5= ')' ) | ( ( (lv_name_6_0= ruleSimpleName ) ) otherlv_7= '(' ( (lv_type_8_0= ruleTypeExp ) ) otherlv_9= ')' ) ) )
            // InternalOCLX.g:1704:2: ( ( ( (lv_name_0_0= ruleSimpleName ) ) otherlv_1= '()' ) | ( ( (lv_name_2_0= ruleSimpleName ) ) otherlv_3= '(' ( (lv_args_4_0= ruleArgumentsExp ) ) otherlv_5= ')' ) | ( ( (lv_name_6_0= ruleSimpleName ) ) otherlv_7= '(' ( (lv_type_8_0= ruleTypeExp ) ) otherlv_9= ')' ) )
            {
            // InternalOCLX.g:1704:2: ( ( ( (lv_name_0_0= ruleSimpleName ) ) otherlv_1= '()' ) | ( ( (lv_name_2_0= ruleSimpleName ) ) otherlv_3= '(' ( (lv_args_4_0= ruleArgumentsExp ) ) otherlv_5= ')' ) | ( ( (lv_name_6_0= ruleSimpleName ) ) otherlv_7= '(' ( (lv_type_8_0= ruleTypeExp ) ) otherlv_9= ')' ) )
            int alt22=3;
            ...
            if ( (LA22_0==RULE_ID) ) {
                ...
                if ( (LA22_1==37) ) {
                    ...
                    if ( (LA22_2==22||(LA22_2>=51 && LA22_2<=54)) ) {
                        alt22=3;
                    }
                    else if ( (LA22_2==RULE_ID||(LA22_2>=RULE_INT && LA22_2<=RULE_STRING)||LA22_2==34||(LA22_2>=36 && LA22_2<=37)||(LA22_2>=39 && LA22_2<=42)) ) {
                        alt22=2;
                    }
                    else {
                        NoViableAltException nvae =
            ...
            switch (alt22) {
                case 1 :
                    // InternalOCLX.g:1705:3: ( ( (lv_name_0_0= ruleSimpleName ) ) otherlv_1= '()' )
                    {
                    // InternalOCLX.g:1705:3: ( ( (lv_name_0_0= ruleSimpleName ) ) otherlv_1= '()' )
                    // InternalOCLX.g:1706:4: ( (lv_name_0_0= ruleSimpleName ) ) otherlv_1= '()'
                    {
                    // InternalOCLX.g:1706:4: ( (lv_name_0_0= ruleSimpleName ) )
                    // InternalOCLX.g:1707:5: (lv_name_0_0= ruleSimpleName )
                    {
                    // InternalOCLX.g:1707:5: (lv_name_0_0= ruleSimpleName )
                    // InternalOCLX.g:1708:6: lv_name_0_0= ruleSimpleName
                    {
                    ...
                    break;
                case 2 :
                    // InternalOCLX.g:1731:3: ( ( (lv_name_2_0= ruleSimpleName ) ) otherlv_3= '(' ( (lv_args_4_0= ruleArgumentsExp ) ) otherlv_5= ')' )
                    {
                    // InternalOCLX.g:1731:3: ( ( (lv_name_2_0= ruleSimpleName ) ) otherlv_3= '(' ( (lv_args_4_0= ruleArgumentsExp ) ) otherlv_5= ')' )
                    // InternalOCLX.g:1732:4: ( (lv_name_2_0= ruleSimpleName ) ) otherlv_3= '(' ( (lv_args_4_0= ruleArgumentsExp ) ) otherlv_5= ')'
                    {
                    // InternalOCLX.g:1732:4: ( (lv_name_2_0= ruleSimpleName ) )
                    // InternalOCLX.g:1733:5: (lv_name_2_0= ruleSimpleName )
                    {
                    // InternalOCLX.g:1733:5: (lv_name_2_0= ruleSimpleName )
                    // InternalOCLX.g:1734:6: lv_name_2_0= ruleSimpleName
                    {
                    ...
                    // InternalOCLX.g:1755:4: ( (lv_args_4_0= ruleArgumentsExp ) )
                    // InternalOCLX.g:1756:5: (lv_args_4_0= ruleArgumentsExp )
                    {
                    // InternalOCLX.g:1756:5: (lv_args_4_0= ruleArgumentsExp )
                    // InternalOCLX.g:1757:6: lv_args_4_0= ruleArgumentsExp
                    {
                    ...
                    break;
                case 3 :
                    // InternalOCLX.g:1780:3: ( ( (lv_name_6_0= ruleSimpleName ) ) otherlv_7= '(' ( (lv_type_8_0= ruleTypeExp ) ) otherlv_9= ')' )
                    {
                    // InternalOCLX.g:1780:3: ( ( (lv_name_6_0= ruleSimpleName ) ) otherlv_7= '(' ( (lv_type_8_0= ruleTypeExp ) ) otherlv_9= ')' )
                    // InternalOCLX.g:1781:4: ( (lv_name_6_0= ruleSimpleName ) ) otherlv_7= '(' ( (lv_type_8_0= ruleTypeExp ) ) otherlv_9= ')'
                    {
                    // InternalOCLX.g:1781:4: ( (lv_name_6_0= ruleSimpleName ) )
                    // InternalOCLX.g:1782:5: (lv_name_6_0= ruleSimpleName )
                    {
                    // InternalOCLX.g:1782:5: (lv_name_6_0= ruleSimpleName )
                    // InternalOCLX.g:1783:6: lv_name_6_0= ruleSimpleName
                    {
                    ...
                    // InternalOCLX.g:1804:4: ( (lv_type_8_0= ruleTypeExp ) )
                    // InternalOCLX.g:1805:5: (lv_type_8_0= ruleTypeExp )
                    {
                    // InternalOCLX.g:1805:5: (lv_type_8_0= ruleTypeExp )
                    // InternalOCLX.g:1806:6: lv_type_8_0= ruleTypeExp
                    {
    ...
    // InternalOCLX.g:1832:1: entryRuleTypeExp returns [EObject current=null] : iv_ruleTypeExp= ruleTypeExp EOF ;
    public final EObject entryRuleTypeExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1832:48: (iv_ruleTypeExp= ruleTypeExp EOF )
            // InternalOCLX.g:1833:2: iv_ruleTypeExp= ruleTypeExp EOF
            {
    ...
    // InternalOCLX.g:1839:1: ruleTypeExp returns [EObject current=null] : ( ( () otherlv_1= '<' ( (lv_name_2_0= rulePath ) ) otherlv_3= '>' ) | ( ( (lv_collectionType_4_0= ruleCollectionTypeIdentifier ) ) ( (lv_type_5_0= ruleTypeExp ) ) ) ) ;
    public final EObject ruleTypeExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1845:2: ( ( ( () otherlv_1= '<' ( (lv_name_2_0= rulePath ) ) otherlv_3= '>' ) | ( ( (lv_collectionType_4_0= ruleCollectionTypeIdentifier ) ) ( (lv_type_5_0= ruleTypeExp ) ) ) ) )
            // InternalOCLX.g:1846:2: ( ( () otherlv_1= '<' ( (lv_name_2_0= rulePath ) ) otherlv_3= '>' ) | ( ( (lv_collectionType_4_0= ruleCollectionTypeIdentifier ) ) ( (lv_type_5_0= ruleTypeExp ) ) ) )
            {
            // InternalOCLX.g:1846:2: ( ( () otherlv_1= '<' ( (lv_name_2_0= rulePath ) ) otherlv_3= '>' ) | ( ( (lv_collectionType_4_0= ruleCollectionTypeIdentifier ) ) ( (lv_type_5_0= ruleTypeExp ) ) ) )
            int alt23=2;
            ...
            switch (alt23) {
                case 1 :
                    // InternalOCLX.g:1847:3: ( () otherlv_1= '<' ( (lv_name_2_0= rulePath ) ) otherlv_3= '>' )
                    {
                    // InternalOCLX.g:1847:3: ( () otherlv_1= '<' ( (lv_name_2_0= rulePath ) ) otherlv_3= '>' )
                    // InternalOCLX.g:1848:4: () otherlv_1= '<' ( (lv_name_2_0= rulePath ) ) otherlv_3= '>'
                    {
                    // InternalOCLX.g:1848:4: ()
                    // InternalOCLX.g:1849:5: 
                    {
                    ...
                    // InternalOCLX.g:1859:4: ( (lv_name_2_0= rulePath ) )
                    // InternalOCLX.g:1860:5: (lv_name_2_0= rulePath )
                    {
                    // InternalOCLX.g:1860:5: (lv_name_2_0= rulePath )
                    // InternalOCLX.g:1861:6: lv_name_2_0= rulePath
                    {
                    ...
                    break;
                case 2 :
                    // InternalOCLX.g:1884:3: ( ( (lv_collectionType_4_0= ruleCollectionTypeIdentifier ) ) ( (lv_type_5_0= ruleTypeExp ) ) )
                    {
                    // InternalOCLX.g:1884:3: ( ( (lv_collectionType_4_0= ruleCollectionTypeIdentifier ) ) ( (lv_type_5_0= ruleTypeExp ) ) )
                    // InternalOCLX.g:1885:4: ( (lv_collectionType_4_0= ruleCollectionTypeIdentifier ) ) ( (lv_type_5_0= ruleTypeExp ) )
                    {
                    // InternalOCLX.g:1885:4: ( (lv_collectionType_4_0= ruleCollectionTypeIdentifier ) )
                    // InternalOCLX.g:1886:5: (lv_collectionType_4_0= ruleCollectionTypeIdentifier )
                    {
                    // InternalOCLX.g:1886:5: (lv_collectionType_4_0= ruleCollectionTypeIdentifier )
                    // InternalOCLX.g:1887:6: lv_collectionType_4_0= ruleCollectionTypeIdentifier
                    {
                    ...
                    // InternalOCLX.g:1904:4: ( (lv_type_5_0= ruleTypeExp ) )
                    // InternalOCLX.g:1905:5: (lv_type_5_0= ruleTypeExp )
                    {
                    // InternalOCLX.g:1905:5: (lv_type_5_0= ruleTypeExp )
                    // InternalOCLX.g:1906:6: lv_type_5_0= ruleTypeExp
                    {
    ...
    // InternalOCLX.g:1928:1: entryRuleCollectionTypeIdentifier returns [EObject current=null] : iv_ruleCollectionTypeIdentifier= ruleCollectionTypeIdentifier EOF ;
    public final EObject entryRuleCollectionTypeIdentifier() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1928:65: (iv_ruleCollectionTypeIdentifier= ruleCollectionTypeIdentifier EOF )
            // InternalOCLX.g:1929:2: iv_ruleCollectionTypeIdentifier= ruleCollectionTypeIdentifier EOF
            {
    ...
    // InternalOCLX.g:1935:1: ruleCollectionTypeIdentifier returns [EObject current=null] : ( ( (lv_name_0_1= 'SET' | lv_name_0_2= 'LIST' | lv_name_0_3= 'MAP' | lv_name_0_4= 'COLLECTION' ) ) ) ;
    public final EObject ruleCollectionTypeIdentifier() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1941:2: ( ( ( (lv_name_0_1= 'SET' | lv_name_0_2= 'LIST' | lv_name_0_3= 'MAP' | lv_name_0_4= 'COLLECTION' ) ) ) )
            // InternalOCLX.g:1942:2: ( ( (lv_name_0_1= 'SET' | lv_name_0_2= 'LIST' | lv_name_0_3= 'MAP' | lv_name_0_4= 'COLLECTION' ) ) )
            {
            // InternalOCLX.g:1942:2: ( ( (lv_name_0_1= 'SET' | lv_name_0_2= 'LIST' | lv_name_0_3= 'MAP' | lv_name_0_4= 'COLLECTION' ) ) )
            // InternalOCLX.g:1943:3: ( (lv_name_0_1= 'SET' | lv_name_0_2= 'LIST' | lv_name_0_3= 'MAP' | lv_name_0_4= 'COLLECTION' ) )
            {
            // InternalOCLX.g:1943:3: ( (lv_name_0_1= 'SET' | lv_name_0_2= 'LIST' | lv_name_0_3= 'MAP' | lv_name_0_4= 'COLLECTION' ) )
            // InternalOCLX.g:1944:4: (lv_name_0_1= 'SET' | lv_name_0_2= 'LIST' | lv_name_0_3= 'MAP' | lv_name_0_4= 'COLLECTION' )
            {
            // InternalOCLX.g:1944:4: (lv_name_0_1= 'SET' | lv_name_0_2= 'LIST' | lv_name_0_3= 'MAP' | lv_name_0_4= 'COLLECTION' )
            int alt24=4;
            switch ( input.LA(1) ) {
            ...
            switch (alt24) {
                case 1 :
                    // InternalOCLX.g:1945:5: lv_name_0_1= 'SET'
                    {
                    ...
                    break;
                case 2 :
                    // InternalOCLX.g:1956:5: lv_name_0_2= 'LIST'
                    {
                    ...
                    break;
                case 3 :
                    // InternalOCLX.g:1967:5: lv_name_0_3= 'MAP'
                    {
                    ...
                    break;
                case 4 :
                    // InternalOCLX.g:1978:5: lv_name_0_4= 'COLLECTION'
                    {
    ...
    // InternalOCLX.g:1994:1: entryRulePath returns [String current=null] : iv_rulePath= rulePath EOF ;
    public final String entryRulePath() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:1994:44: (iv_rulePath= rulePath EOF )
            // InternalOCLX.g:1995:2: iv_rulePath= rulePath EOF
            {
    ...
    // InternalOCLX.g:2001:1: rulePath returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : (this_SimpleName_0= ruleSimpleName (kw= '/' this_SimpleName_2= ruleSimpleName )* ) ;
    public final AntlrDatatypeRuleToken rulePath() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:2007:2: ( (this_SimpleName_0= ruleSimpleName (kw= '/' this_SimpleName_2= ruleSimpleName )* ) )
            // InternalOCLX.g:2008:2: (this_SimpleName_0= ruleSimpleName (kw= '/' this_SimpleName_2= ruleSimpleName )* )
            {
            // InternalOCLX.g:2008:2: (this_SimpleName_0= ruleSimpleName (kw= '/' this_SimpleName_2= ruleSimpleName )* )
            // InternalOCLX.g:2009:3: this_SimpleName_0= ruleSimpleName (kw= '/' this_SimpleName_2= ruleSimpleName )*
            {
            ...
            // InternalOCLX.g:2019:3: (kw= '/' this_SimpleName_2= ruleSimpleName )*
            loop25:
            do {
                int alt25=2;
                ...
                switch (alt25) {
            	case 1 :
            	    // InternalOCLX.g:2020:4: kw= '/' this_SimpleName_2= ruleSimpleName
            	    {
    ...
    // InternalOCLX.g:2040:1: entryRuleArgumentsExp returns [EObject current=null] : iv_ruleArgumentsExp= ruleArgumentsExp EOF ;
    public final EObject entryRuleArgumentsExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:2040:53: (iv_ruleArgumentsExp= ruleArgumentsExp EOF )
            // InternalOCLX.g:2041:2: iv_ruleArgumentsExp= ruleArgumentsExp EOF
            {
    ...
    // InternalOCLX.g:2047:1: ruleArgumentsExp returns [EObject current=null] : ( ( (lv_operators_0_0= ruleExp ) ) (otherlv_1= ',' ( (lv_operators_2_0= ruleExp ) ) )* ) ;
    public final EObject ruleArgumentsExp() throws RecognitionException {
        ...
        try {
            // InternalOCLX.g:2053:2: ( ( ( (lv_operators_0_0= ruleExp ) ) (otherlv_1= ',' ( (lv_operators_2_0= ruleExp ) ) )* ) )
            // InternalOCLX.g:2054:2: ( ( (lv_operators_0_0= ruleExp ) ) (otherlv_1= ',' ( (lv_operators_2_0= ruleExp ) ) )* )
            {
            // InternalOCLX.g:2054:2: ( ( (lv_operators_0_0= ruleExp ) ) (otherlv_1= ',' ( (lv_operators_2_0= ruleExp ) ) )* )
            // InternalOCLX.g:2055:3: ( (lv_operators_0_0= ruleExp ) ) (otherlv_1= ',' ( (lv_operators_2_0= ruleExp ) ) )*
            {
            // InternalOCLX.g:2055:3: ( (lv_operators_0_0= ruleExp ) )
            // InternalOCLX.g:2056:4: (lv_operators_0_0= ruleExp )
            {
            // InternalOCLX.g:2056:4: (lv_operators_0_0= ruleExp )
            // InternalOCLX.g:2057:5: lv_operators_0_0= ruleExp
            {
            ...
            // InternalOCLX.g:2074:3: (otherlv_1= ',' ( (lv_operators_2_0= ruleExp ) ) )*
            loop26:
            do {
                int alt26=2;
                ...
                switch (alt26) {
            	case 1 :
            	    // InternalOCLX.g:2075:4: otherlv_1= ',' ( (lv_operators_2_0= ruleExp ) )
            	    {
            	    otherlv_1=(Token)match(input,55,FOLLOW_13); 

            	    				newLeafNode(otherlv_1, grammarAccess.getArgumentsExpAccess().getCommaKeyword_1_0());
            	    			
            	    // InternalOCLX.g:2079:4: ( (lv_operators_2_0= ruleExp ) )
            	    // InternalOCLX.g:2080:5: (lv_operators_2_0= ruleExp )
            	    {
            	    // InternalOCLX.g:2080:5: (lv_operators_2_0= ruleExp )
            	    // InternalOCLX.g:2081:6: lv_operators_2_0= ruleExp
            	    {
    ...
    public static final BitSet FOLLOW_13 = new BitSet(new long[]{0x000007B4000000D0L});
